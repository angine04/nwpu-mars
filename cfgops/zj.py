...
def mcfg(tags):
    ...
    # data setup
    mcfg.imageDir = "G:/mar20/images"
    mcfg.annotationDir = "G:/mar20/annotations"
    mcfg.classList = ["A{}".format(x) for x in range(1, 21)] # DO NOT MODIFY
    mcfg.subsetMap = { # DO NOT MODIFY
        "train": "G:/mar20/splits/v5/train.txt",
        "validation": "G:/mar20/splits/v5/validation.txt",
        "test": "G:/mar20/splits/v5/test.txt",
        "small": "G:/mar20/splits/v5/small.txt",
    }
    
    # ema  add to your setting
    mcfg.use_ema = True
