...
def mcfg(tags):
    ...
    # data setup
    mcfg.imageDir = "/Users/zheyu/Repositories/mars/mar20/images"
    mcfg.annotationDir = "/Users/zheyu/Repositories/mars/mar20/annotations"
    mcfg.classList = ["A{}".format(x) for x in range(1, 21)] # DO NOT MODIFY
    mcfg.subsetMap = { # DO NOT MODIFY
        "train": "/Users/zheyu/Repositories/mars/mar20/splits/v5/train.txt",
        "validation": "/Users/zheyu/Repositories/mars/mar20/splits/v5/validation.txt",
        "test": "/Users/zheyu/Repositories/mars/mar20/splits/v5/test.txt",
        "small": "/Users/zheyu/Repositories/mars/mar20/splits/v5/small.txt",
    }
